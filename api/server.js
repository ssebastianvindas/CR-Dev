...
app.use("/api", require("./routes/expedientes.routes"));
app.use("/api", require("./routes/tratamientos.routes"));
app.use("/api", require("./routes/vacunas.routes"));
app.use("/api", require("./routes/laboratorios.routes"));
...
app.use("/api", require("./routes/reporteHotel.routes"));
app.use("/api", require("./routes/reporteVete.routes"));
